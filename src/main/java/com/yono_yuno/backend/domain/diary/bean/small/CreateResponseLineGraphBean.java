...
import com.yono_yuno.backend.domain.diary.bean.matching.DatePriceMatching;
import com.yono_yuno.backend.domain.diary.bean.matching.MonthMatching;
...
@Component
public class CreateResponseLineGraphBean {
    private final DatePriceMatching datePriceMatching;
    private final MonthMatching monthMatching;

    public CreateResponseLineGraphBean(DatePriceMatching datePriceMatching, MonthMatching monthMatching) {
